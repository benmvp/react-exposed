    ...
    return (
      <div>
        <h1>
          Unique Value as Key (
          <a
            href="https://github.com/benmvp/react-exposed/blob/master/src/containers/UniqueKeyPage.js"
            target="_blank"
        ...
        <aside>
          <p>
            Because the code is using a unique value as the <code>key</code>,
            when the ADD button is clicked only the new item is inserted, which
            properly leverages the virtual DOM optimizations!
          </p>
